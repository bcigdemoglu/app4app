...
export const metadata = {
  title: "Ilayda's Business Blog",
  description: 'Get the latest from Ilayda',
};
...
export default function Page() {
  return (
    <>
      <Navbar />
      <div className='lg:prose-xs prose prose-a:no-underline container m-auto mb-20 flex max-w-4xl flex-col p-4 pt-32'>
        <section>
        ...
        <section className='animation-delay-2 fade-in mt-8 grid grid-cols-1 will-change-transform lg:grid-cols-2'>
          {allPosts.map((post) => (
            <Link
              key={post.slug}
              href={post.url}
            ...
            >
              ...
              <div className='p-8'>
                ...
                <p className='my-2 line-clamp-3'>{post.description}</p>
                <p className='m-0 '>
