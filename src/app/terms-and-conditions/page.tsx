      ...
      <div data-custom-class='body'>
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          >
            ...
            >
              ...
              &quot;<strong>you</strong>&quot;
              <span className='statement-end-if-in-editor' />
              ), and <span className='question'>Cloudybook</span>, concerning
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          >
            ...
            <span style={{ fontSize: '15px' }}>
              <span className='block-component' />
              &quot;
              <span className='statement-end-if-in-editor' /> section below, we
          ...
          >
            ...
            >
              ...
              <span className='question'>info@cloudybook.com</span>. If we ever
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              <span className='block-component' />
              &quot;
              <span className='statement-end-if-in-editor' /> section carefully
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              the Services (<span className='block-component' />
              &quot;Submissions&quot;
              <span className='statement-end-if-in-editor' />
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              of the Services
              <span className='block-component' /> and possibly through
          ...
          >
            <span style={{ fontSize: '15px' }}>
              <strong>
                ...
                <span className='block-component' />
                license
                <span className='statement-end-if-in-editor' /> (including use
              ...
              Contributions, and to <span className='block-component' />
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              license
              <span className='statement-end-if-in-editor' /> includes our use
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              <span className='statement-end-if-in-editor' /> through any part
              of the Services
              <span className='block-component' /> or making Contributions
          ...
          <ul>
            ...
            >
              <span style={{ fontSize: '15px' }}>
                ...
                <span className='statement-end-if-in-editor' /> are original to
                ...
                Submissions
                <span className='block-component' /> and/or Contributions
                <span className='statement-end-if-in-editor' /> and that you
            ...
            >
              <span style={{ fontSize: '15px' }}>
                ...
                <span className='block-component' /> and/or Contributions
                <span className='statement-end-if-in-editor' /> do not
          ...
          >
            ...
            <span className='block-component' /> and/or Contributions
            <span className='statement-end-if-in-editor' /> and you expressly
          ...
          >
            ...
            refer to the <span className='block-component' />
            &quot;
            <span className='statement-end-if-in-editor' />
            <a data-custom-class='link' href='#dmca'>
              <span style={{ color: 'rgb(0, 58, 250)' }}>
        ...
        <div style={{ textAlign: 'left' }}>
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              <span className='block-component' />
              canceled
              <span className='statement-end-if-in-editor' />. You consent to
              ...
              <span className='block-component' /> The length of your billing
              cycle <span className='block-component' />
          ...
          >
            <span style={{ fontSize: '15px' }}>
              We offer a <span className='question'>__________</span>-day free
          ...
          >
            ...
            account.
            <span className='block-component' /> Your cancellation will take
                    ...
                    <span data-type='body'>
                      ...
                      >
                        ...
                        >
                          ...
                          (collectively, <span className='block-component' />
                          &quot;Contributions&quot;
                          <span className='statement-end-if-in-editor' />
                ...
                <span data-type='body'>
                  ...
                  >
                    ...
                    >
                      This <span className='block-component' />
                      license
                      <span className='statement-end-if-in-editor' /> will apply
                ...
                <span data-type='body'>
                  ...
                  >
                    ...
                    >
                      ...
                      Contributions; (2) to <span className='block-component' />
                      re-categorize
          ...
          >
            ...
            <strong>
              ...
              <span style={{ color: 'rgb(0, 58, 250)' }}>
                ...
                >
                  <a
                    href='https://app.cloudybook.com/privacy-policy'
                    target='_blank'
                    data-custom-class='link'
                  >
            ...
            <span className='block-component' />, then through your continued
            ...
            <span className='block-component' />, and you expressly consent to
        ...
        >
          <span style={{ fontSize: '15px' }}>
            ...
            <span className='statement-end-if-in-editor' />) shall be commenced
            ...
            <span className='block-component' />{' '}
            <span className='question'>Santa Clara County</span>,
            <span className='statement-end-if-in-editor' />{' '}
            <span className='block-component' />
            <span className='question'>California</span>
            <span className='statement-end-if-in-editor' />, and the Parties
        ...
        >
          ...
          >
            ...
            <span className='block-component' />
            UNAUTHORIZED
            <span className='statement-end-if-in-editor' /> ACCESS TO OR USE OF
        ...
        >
          ...
          >
            ...
            <span className='block-component' />
            defense
            <span className='statement-end-if-in-editor' /> of such claims. We
        ...
        >
          ...
          >
            ...
            <span className='block-component' />
            defenses
            <span className='statement-end-if-in-editor' /> you may have based
